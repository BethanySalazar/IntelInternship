...
while(1 <= widthOfCone):
    answer = " "
    for i in range(widthOfCone): i = 0
    if(i%2==0):
        answer += '0'
    else:
        answer += '1'
print(answer.center(widthOfCone, ""))


"""
x = [[(i+j)%2 for i in range(widthOfCone)]for j in range (widthOfCone)] #generates random 0s and 1s with the width
